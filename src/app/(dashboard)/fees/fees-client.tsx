...
import { Search, Zap, Receipt, Loader2, ArrowRight, CheckCircle2, Clock } from "lucide-react";
...
export function FeesClient({ initialChallans, initialMonth, initialYear }: FeesClientProps) {
